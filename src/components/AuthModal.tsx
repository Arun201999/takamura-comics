...
const AuthModal = ({
  ...
  return <div className="w-full max-w-md mx-auto p-6 space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-muted-foreground hover:text-primary" onClick={e => {
                e.preventDefault();
                toast({
        ...
        <TabsContent value="register" className="space-y-6 animate-in fade-in-50">
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="register-password" type="password" placeholder="Create a password (min. 6 characters)" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={role} onValueChange={value => setRole(value as UserRole)}>
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="reader" className="bg-red-600">Reader</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="artist" id="artist" />
                  <Label htmlFor="artist" className="bg-red-500">Comic Artist</Label>
                </div>
              </RadioGroup>
            </div>
