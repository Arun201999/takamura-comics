              ...
              {user ? (
                <>
                  ...
                  <div className="mt-3 space-y-2">
                    <Link
                      to="/profile"
                      className="block text-sm p-2 hover:bg-secondary rounded-md transition-colors"
                    >
                      Profile
                    </Link>
                    <Link
                    ...
                    <button
                      onClick={() => logout()}
                      className="block w-full text-left text-sm p-2 hover:bg-secondary rounded-md transition-colors"
                    >
                      Log out
                    </button>
                  </div>
